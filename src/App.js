...
function App() {
  ...
  return (
    ...
    <div className="main">
     ...
     huge old monitor. I believe I picked up a keyboard before I even picked up a pen, and it all started with electronic games. At first I was playing every game I could play, I was always fascinated with how everything works and how those games were made, so I just let my cursioty take the wheel. 22 years later, I'm pursuing a career in what I love and I am still looking forward to learning more with the same fiery passion that led me here.<br/> I started off coding some basic projects in C and later on in Python, and I've picked up quite a few skills along the way, below you'll find more details about what I can do !</p>
